...
describe ArticleCell do
  context "cell rendering" do 
    ...
    context "rendering display_on_main" do
      ...
      it { should have_selector("h1", :content => "Article#display_on_main") }
      it { should have_selector("p", :content => "Find me in app/cells/article/display_on_main.html") }
    end
    
    context "rendering display_linked" do
      subject { render_cell(:article, :display_linked) }
  
      it { should have_selector("h1", :content => "Article#display_linked") }
      it { should have_selector("p", :content => "Find me in app/cells/article/display_linked.html") }
    end
